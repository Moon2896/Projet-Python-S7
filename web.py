...
page_name = ['Data Preprocessing','Data Visualization', 'Modeling and Outputs']

page = st.sidebar.selectbox('Select page', page_name  )

######################################" ALL PROCESSES AND FUNCTIONS "
...
###################################### Visualization
    ...
    clist1 = df.columns
    param1 = st.selectbox("Select a first variable:",clist1)
    clist2 = df.columns
    param2 = st.selectbox("Select a second variable:",clist2)


    figX = px.scatter(df, 
        x = param1, y = param2,
        title = f'Scatter plot of "{param1}" / "{param2}"',
        color="y"
        )
